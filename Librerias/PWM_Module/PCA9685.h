...
/**
 * @brief Dirección I2C por defecto del PCA9685.
 */
...
// Timeout
#define PCA9685_MAX_TIMEOUT 800          /**< Tiempo máximo de espera para operaciones I2C en ms */
...
/**
 * @brief Enumeración para estados de retorno del PCA9685.
 */
typedef enum {
